...
class Settings(BaseSettings):
    ...
    llm_base_url: str = Field(default="http://192.168.0.112:8006/v1", alias="LLM_BASE_URL")
    llm_model: str = Field(
    ...
    searxng_base_url: str = Field(default="http://192.168.0.194:8888", alias="SEARXNG_BASE_URL")
