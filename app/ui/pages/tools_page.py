...
<div class="o_page_body">
  ...
  <section class="o_section_box">
    <h2>LLM — endpoint</h2>
    <p class="o_page_intro">Serwer OpenAI-compatible (Bielik lokalnie, OpenRouter lub własny). Zapis trafia do <code>config.yaml</code>. BC-250 wake działa tylko dla lokalnego Bielika (:8000/:8006).</p>
    ...
    <div class="o_form_group">
      ...
      <input id="llmCustomUrl" type="text" placeholder="http://192.168.0.112:8006/v1" />
    </div>
    <div class="o_form_group">
